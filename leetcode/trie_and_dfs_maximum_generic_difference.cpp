// Problem Statement: https://leetcode.com/contest/weekly-contest-250/problems/maximum-genetic-difference-query/
...
int main() {
    vector<int>A{3,7,-1,2,0,7,0,2};
    vector<vector<int>>B{{4,6},{1,15},{0,5}};
    Solution s;
    auto ans = s.maxGeneticDifference(A,B);
